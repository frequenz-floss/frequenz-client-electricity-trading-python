# Contributing to Frequenz Electricity Trading API Client
...
5. A GitHub action will test the tag and if all goes well it will create
   a [GitHub
   Release](https://github.com/frequenz-floss/frequenz-client-electricity-trading-python/releases),
   and upload a new package to
   [PyPI](https://pypi.org/project/frequenz-client-electricity-trading/)
   automatically.
